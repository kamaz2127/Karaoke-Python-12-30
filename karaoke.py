...
WINDOW_WIDTH = 800
WINDOW_HEIGHT = 600
BACKGROUND_COLOR = (0, 50, 10)  # Темно-синій фон (R, G, B)
LINE_COLOR = (0, 255, 0)       # Блакитна хвиля
...
MINUS_TRACK = "mic-wave-pygame/MinusSmaragdSky.mp3"
# ==========================================
...
def start_voice_record():
    ...
    recording = sd.rec(int(fs * 100), samplerate=fs, channels=1, dtype='int16')
